...
- Fonturi self-hosted prin `next/font/local`: Cormorant Garamond (400–600 + italic) și DM Sans (400–600),
  restrânse la caracterele folosite (vezi addendum-ul din ADR 0005).
